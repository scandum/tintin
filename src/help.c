...
struct help_type help_table[] =
{
...

	{
		...
		"<278>         separate two or more commands. It is NOT a command terminator. Trailing\n"
		"<278>         semi-colons are ignored when reading a script file as this is a common\n"
		"<278>         user mistake, but there are cases where this results in a syntax error.\n"
		"\n"
	...
	},
	{
		...
		"\n"
		"<178>Example<278>: #draw azure Yellow calign box 1 16 5 50 SQUARE COORDINATE AREA\n"
		"\n"
		"<128>         (Top Row, Left Col)\n"
		"<acf>          <118>1,16  <acf>┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\n"
		"<acf>                ┃                                  ┃\n"
		"<acf>                ┃      <138>SQUARE COORDINATE AREA<acf>      ┃\n"
		"<acf>                ┃                                  ┃\n"
		"<acf>                ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛  <110>5,50\n"
		"<128>                                    (Bottom Row, Right Col)\n"
		"\n"
		"<278>         <128>Panes\n"
		"\n"
	...
	},
	{
		...
		"\n"
		"<278>         Named delays are converted to one-shot tickers, see #help tick and #help\n"
		"<278>         line.\n"
		"\n"
		...
		"<278>         a name as the first argument, be aware this changes the syntax.\n",
	...
	},
	{
		...
		"\n"
		"<278>         Terminates tintin and return to unix.  You can also press ctrl-d on an\n"
		"<278>         empty line to quit.\n"
		"\n"
	...
	},
	{
		...
		"<278>           behavior.\n"
		"\n"
		"<278>         <128>CHAT EVENTS (raised in gts)\n"
		"\n"
		...
		"\n"
		"<278>         <178>MAP FOLLOW MAP, MAP FOLLOW GLOBAL\n"
		...
		"\n"
		"<278>         <128>SYSTEM EVENTS (raised in gts)\n"
		"\n"
		"<278>         <178>PROGRAM START          <278>%0..%99 startup arguments\n"
...
//		"<268>      #<278>                                                                  <268>#\n"
	...
	},
	{
		...
		"\n"
		"<278>         Besides color names also <<888>xyz> color codes can be used.\n"
		"\n"
		...
		"action colors gag prompt substitute"
	},
	{
		"HISTORY",
		TOKEN_TYPE_COMMAND,
	...
	},
	{
		...
		"<278>         #session x mymud.com 1234\n"
		"\n"
		"<278>         If you use a hashbang, and make the 'mymud.tin' file executable using\n"
		"<278>         'chmod 764 mymud.tin', you can launch tintin using './mymud.tin'.\n"
		"\n"
		"<278>         <128>Highlight\n"
		"\n"
	...
	},
	{
		...
		"<278>         terminal's application keypad mode, which can be disabled using\n"
		"<278>         #cursor flag keypad off.\n"
		"\n"
	...
	},
	{
		...
		"<278>           Log the current or next line to file, unless the [text] argument\n"
		"<278>           is provided, in which case the given text is logged.\n"
		"\n"
	...
	},
	{
		...
		"<278>         #list {var} {reverse} [items]          Reverse the list\n"
		...
		"<278>         #list {var} {tabulate} [key]           Turn a list into a table\n"
...

	{
		...
		"<278>         issues when frequently inserting and removing items in the beginning\n"
		"<278>         or middle of the table.\n"
		"\n"
		...
		"\n"
		"<278>         To copy large tables use: #list <variable> copy <variable>\n"
		"\n"
...

	{
		...
		"<278>           When set the timestamp will be prepended to each line logged to\n"
		"<278>           file. The format will be formatted as a date using the strftime\n"
		"<278>           format specifiers as described in #help time.\n"
		"\n"
		"<278>         <178>#line log <filename> [text]\n"
		"<278>           Log the current or next line to file, unless the [text] argument is\n"
		"<278>           provided, in which case the given text is logged.\n"
		,
		"line read scan textin time write"
	},
	...
	},
	{
		...
		"<278>           Draw rooms using 3x6 characters with greater detail, like the\n"
		"<278>           ne se sw nw exits and room symbols.\n"
		"\n"
		"<278>         <178>#map flag asciivnums\n"
		"<278>           Display room vnums if asciigraphics is enabled.\n"
		"\n"
		"<278>         <178>#map flag blockgraphics\n"
		"<278>           Compact 2x5 version of asciigraphics using unicode characters.\n"
		"<278>           Does not support diagonal exits.\n"
		"\n"
		...
		"\n"
		"<278>         <178>#map flag mudfont\n"
		"<278>           Draw rooms using 1x2 characters utilizing unicode characters.\n"
		"<278>           Displays diagonal exits and room symbols, but not up/down.\n"
		"\n"
		"<278>         <178>#map flag nofollow\n"
		"<278>           When you enter movement commands the map will no longer\n"
		"<278>           automatically follow along. Useful for MSDP and GMCP automapping\n"
		"<278>           scripts. When you use #map find in nofollow mode it will store the\n"
		"<278>           exit command instead of the exit name into the path.\n"
		"\n"
		"<278>         <178>#map flag pancake\n"
		"<278>           Makes the map display rooms above or below you. You can use\n"
		"<278>           #map color room <<888>aaa><<888>fff> for a color gradient.\n"
		"\n"
		"<278>         <178>#map flag quiet\n"
		"<278>           Silence map messages when creating new rooms through movement.\n"
		"\n"
		"<278>         <178>#map flag static\n"
		"<278>           Will make the map static so new rooms are no longer created when\n"
		"<278>           walking into an unmapped direction. Useful once you're done\n"
		"<278>           mapping. #map dig etc will still work.\n"
		"\n"
		"<278>         <178>#map flag simplegraphics\n"
		"<278>           Draw rooms using 1 character utilizing unicode line characters.\n"
		"\n"
		"<278>         <178>#map flag symbolgraphics\n"
		"<278>           Draw rooms using 1 character displaying the defined room symbols.\n"
		"\n"
		"<278>         <178>#map flag terrain\n"
		"<278>           Fill up empty space surrounding rooms with terrain symbols\n"
		"\n"
		"<278>         <178>#map flag unicodegraphics\n"
		"<278>           Compact 2x5 version of asciigraphics using unicode characters.\n"
		"\n"
		"<278>         <178>#map flag vtmap\n"
		"<278>           Will enable the vtmap which is shown in the top split screen if you\n"
		"<278>           have one. You can create a 16 row top screen using '#split 16 1'.\n"
		"\n"
...
//		"<268>         │<178>   yocto <268>│<178>      y <268>│<178>0.000 000 000 000 000 000 000 001<268>│\n"
	...
	},
	{
		...
		"<278>         save     Save the path to a variable. You can specify whether you\n"
		"<278>                  want to save the path 'forward', 'backward', or 'both'.\n"
	...
	},
	{
		"REGEXP",
		TOKEN_TYPE_COMMAND,
		"<178>Command<278>: #regex <178>{<278>string<178>} {<278>expression<178>} {<278>true<178>} {<278>false<178>}\n"
		"\n"
