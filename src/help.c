...
//		"<268>      #<278>                                                                  <268>#\n"
...

	{
		...
		"\n"
		"<278>         <178>#log append [name] [color_filter] <filename>\n"
		"<278>           Start logging to the given file, if the file already exists it won't\n"
		"<278>           be overwritten and data will be appended to the end. You can assign\n"
		"<278>           a name to multiplex logs, and a color tag to filter output.\n"
		"\n"
		...
		"\n"
		"<278>         <178>#log overwrite [name] [color_filter] <filename>\n"
		"<278>           Start logging to the given file, if the file already exists it will\n"
		"<278>           be overwritten. Names and color tags can optionally be provided.\n"
		"\n"
		"<278>         <178>#log off [name | ALL]\n"
		"<278>           Stop logging for the 'default' log, a named log, or ALL logs.\n"
		"\n"
		"<278>         <178>#log info\n"
		"<278>           Show the current state, filters, and filepaths of all active logs.\n"
		"\n"
		"<278>         <178>#log remove <filename>\n"
		"<278>           Remove the file. This can be any file and doesn't need to be a log\n"
		"<278>           file.\n"
		"\n"
		"<278>         <178>#log timestamp [name | ALL] <format>\n"
		"<278>           When set the timestamp will be prepended to each line logged to file.\n"
		"<278>           If a name is provided, it applies only to that specific multiplexed log.\n"
