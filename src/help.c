...
struct help_type help_table[] =
{
...

	{
		...
		"\n"
		"         [HORIZONTAL] <178>BAR<278> {<MIN>;<MAX>;[COLOR]}\n"
		"          will draw a bar, use two 256 color codes for a color gradient.\n"
		"         [ASCII|UNICODE|HUGE] <178>BOX<278> {[TEXT1]} {[TEXT2]}\n"
		"           will draw a box.\n"
		"         [BOXED|FOREGROUND] <178>BUFFER\n"
		"           will draw the scrollback buffer.\n"
		"         [BLANKED|CIRCLED|CROSSED|JEWELED|ROUNDED|TEED|PRUNED] <178>CORNER\n"
		"           will draw a corner.\n"
		"         [BLANKED|HORIZONTAL|NUMBERED|TUBED|VERTICAL] <178>LINE<278> {[TEXT]}\n"
		"           will draw a line.\n"
		"         [BOXED] <178>MAP\n"
		"           will draw the map\n"
		"         <178>RAIN<278> {<VARIABLE>} {[SPAWN]} {[FADE]} {[LEGEND]}\n"
		"           will draw digital rain.\n"
		"         [JOINTED|TOP|LEFT|BOTTOM|RIGHT] <178>SIDE\n"
		"           will draw one or more sides of a box.\n"
		"         [GRID] <178>TABLE<278> {[LIST1]} {[LIST2]}\n"
		"          will draw a table.\n"
		"         [CURSIVE|FAT|HUGE|SANSSERIF] <178>TILE<278> {[TEXT1]} {[TEXT2]}\n"
		"           will draw a tile\n"
		"\n"
	...
	},
	{
		...
		"         <178>RECEIVED OUTPUT        <278>%0 raw text %1 plain text\n"
...
//		"<268>      #<278>                                                                  <268>#\n"
	...
	},
	{
		...
		"\n"
		"         <<888>abd> - azure                 <<888>acf> - Azure\n"
		"         <<888>aad> - blue                  <<888>aaf> - Blue\n"
		"         <<888>add> - cyan                  <<888>aff> - Cyan\n"
		"         <<888>aaa> - ebony                 <<888>bbb> - Ebony\n"
		"         <<888>ada> - green                 <<888>afa> - Green\n"
		"         <<888>adb> - jade                  <<888>afc> - Jade\n"
		"         <<888>bda> - lime                  <<888>cfa> - Lime\n"
		"         <<888>dad> - magenta               <<888>faf> - Magenta\n"
		"         <<888>dba> - orange                <<888>fca> - Orange\n"
		"         <<888>dab> - pink                  <<888>fac> - Pink\n"
		"         <<888>daa> - red                   <<888>faa> - Red\n"
		"         <<888>ccc> - silver                <<888>eee> - Silver\n"
		"         <<888>cba> - tan                   <<888>eda> - Tan\n"
		"         <<888>bad> - violet                <<888>caf> - Violet\n"
		"         <<888>ddd> - white                 <<888>fff> - White\n"
		"         <<888>dda> - yellow                <<888>ffa> - Yellow\n"
		"\n"
	...
	},
	{
		...
		"\n"
		"         <128>Giving Credit Where Credit is Due\n"
		"\n"
	...
	},
	{
		...
		"                   <178>{<278>tell bob %1 told me '%2'<178>}<278> -- forward tells.\n"
		"\n"
		...
		"\n"
		"\n"
		"         <128>That's all for the introduction, enjoy\n"
		,
	...
	},
	{
		...
		"\n"
		"         <178>#line json <variable> <argument>\n"
...

	{
		...
		"         <258>{\n"
		"                 <258>{<178>1<258>} {<178>Bubba chats Hi<258>}\n"
		"                 <258>{<178>2<258>} {<178>Bob chats Hi bub<258>}\n"
		"                 <258>{<178>3<258>} {<178>Bubba chats Bye<258>}\n"
		"                 <258>{<178>4<258>} {<178>Bob chats bub bye<258>}\n"
		"         <258>}\n"
		"\n"
		"<128>         Parsing\n"
		"\n"
	...
	},
	{
		...
		"           name into the path.\n"
		"\n"
		"         <178>#map flag pancake\n"
		"           Makes the map display rooms above or below you. You can use\n"
		"           #map color room <aaa><fff> for a color gradient.\n"
		"\n"
		"         <178>#map flag quiet\n"
		...
		"\n"
		"         <178>#map flag symbolgraphics\n"
		"           Draw a 1x1 map using the defined room symbols.\n"
		"\n"
		"         <178>#map flag terrain\n"
...

	{
		...
		"         landmark.\n"
		"\n"
		"         <178>#map landmark firstroom 1\n"
		"\n"
		"         You can further narrow down the matches by providing additional\n"
		"         arguments, for example:\n"
		"\n"
		"         <178>#map goto {dark alley} {roomexits} {n;e} {roomarea} {Haddock Ville}\n"
		"\n"
...
//		"<268>         │<178>   yocto <268>│<178>      y <268>│<178>0.000 000 000 000 000 000 000 001<268>│\n"
...

	{
		...
		"\n"
		"         <168>https://tintin.sourceforge.io/protocols/msdp\n"
		,
		"event port"
	},
	...
	},
	{
		...
		"\n"
		"         <128>Perl Compatible Regular Expressions\n"
		"\n"
	...
	},
	{
		...
		"         #split is enabled.\n"
		"\n"
		"         To mitigate this you can use <178>#config packet_patch 0.5<278>.\n"
		"\n"
		...
		"\n"
		"         To view control codes you can use <178>#config convert_meta on<278> which will\n"
		...
		"         blocks by using #event {RECEIVED OUTPUT} {#echo <<888>058>%+80h BLOCK}\n"
		"\n"
